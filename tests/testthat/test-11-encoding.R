...
tt_ref_encoding(encoding = "Korean",
...
tt_ref_encoding(encoding = "Japanese",
                "Non-English encodings don't fail reading unicode from github",
                {
                  check_api()
...
tt_ref_encoding(encoding = "Russian",
                "Non-English encodings don't fail reading unicode from github",
                {
                  check_api()
