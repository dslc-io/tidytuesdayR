...
1. [Wrangle] the data: `tt_clean()`
2. [Save & document] the data: `tt_save_dataset()`
3. [Introduce] the data: `tt_intro()`
4. [Find images] (or create them).
5. [Provide metadata]: `tt_meta()`
6. [Submit] for review: `tt_submit()`
