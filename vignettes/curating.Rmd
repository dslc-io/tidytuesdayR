...
To avoid entering your attribution information every time you submit a dataset, we recommend adding your details to your `.Rprofile`.
Open your `.Rprofile` with `usethis::edit_r_profile()`, then add an options block like this:
...
After saving and restarting R, `tt_meta()` will use these values as defaults.
...
**Note:** To avoid confusion, we recommend that you [login to GitHub.com](https://github.com/login) before you run this command.
