...
Source:
[`DESCRIPTION`](https://github.com/dslc-io/tidytuesdayR/blob/copilot/check-alt-text-length/DESCRIPTION)

Harmon J, Hughes E (2026). *tidytuesdayR: Access the Weekly
'TidyTuesday' Project Dataset*. R package version 1.3.2.9000,
